...
class ProductCard extends StatelessWidget {
  ...
  final VoidCallback onTap; // ✅ NEW: Function to handle taps
  ...
  const ProductCard({
    ...
    required this.onTap, // ✅ NEW: Add this to constructor
  });
  ...
  Widget build(BuildContext context) {
    ...
    return InkWell(
      onTap: onTap, // ✅ Call the passed-in function when tapped
      child: Card(
        elevation: 3,
        child: Column(
